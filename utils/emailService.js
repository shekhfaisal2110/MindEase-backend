...
// // // //       sender: { name: 'MindEase', email: process.env.BREVO_SENDER_EMAIL },
// // // //       to: [{ email: toEmail, name: username }],
// // // //       subject: 'Your OTP for MindEase',
// // // //       htmlContent: `
...
// // // //           <hr />
// // // //           <p style="font-size: 12px; color: gray;">MindEase - Your mental health companion</p>
// // // //         </div>
// // // //       `
// // // //     }, {
...
// // //     console.log(`\n🔐 DEVELOPMENT MODE: OTP for ${toEmail} is: ${otp}\n`);
...
// // //       to: [{ email: toEmail, name: username }],
// // //       subject: 'Your OTP for MindEase',
// // //       htmlContent: `<div><h2>Hello ${username},</h2><h1>${otp}</h1><p>Valid for 10 minutes.</p></div>`
// // //     }, {
// // //       headers: { 'api-key': process.env.BREVO_API_KEY, 'Content-Type': 'application/json' }
// // //     });
// // //   } catch (error) {
...
// //       sender: {
// //         name: 'MindEase',
// //         email: process.env.BREVO_SENDER_EMAIL, // shekhfaisal.2110@gmail.com
// //       },
// //       to: [{ email: toEmail, name: username }],
// //       subject: 'Your OTP for MindEase',
// //       htmlContent: `
...
// // Initialize Brevo client only if API key exists and we are in production
// const initBrevo = () => {
...
// const sendOTPEmail = async (toEmail, otp, username) => {
//   // In development or if we already know Brevo is not activated → log only
