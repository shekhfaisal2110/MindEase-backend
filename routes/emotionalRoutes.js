...
// routes/emotionalRoutes.js
const express = require('express');
const router = express.Router();
const auth = require('../middleware/auth');
const emotionalController = require('../controllers/emotionalActivityController');

router.use(auth);

router.get('/', emotionalController.getActivities);
router.post('/', emotionalController.createActivity);
router.get('/stats', emotionalController.getStats);
router.get('/trend/:emotion', emotionalController.getEmotionTrend); // unified endpoint
router.delete('/:id', emotionalController.deleteActivity);
