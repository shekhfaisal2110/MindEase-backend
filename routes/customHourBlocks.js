...
// routes/customHourBlockRoutes.js
const express = require('express');
const router = express.Router();
const auth = require('../middleware/auth');
const customHourBlockController = require('../controllers/customHourBlockController');

router.use(auth);
router.get('/:date', customHourBlockController.getBlocks);
router.post('/:date', customHourBlockController.saveBlocks);
