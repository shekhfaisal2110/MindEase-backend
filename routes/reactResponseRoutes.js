...
// routes/reactResponseRoutes.js
const express = require('express');
const router = express.Router();
const auth = require('../middleware/auth');
const reactResponseController = require('../controllers/reactResponseController');

router.use(auth);
router.get('/', reactResponseController.getAll);
router.get('/month/:year/:month', reactResponseController.getMonthlySummary);
router.post('/', reactResponseController.create);
router.delete('/:id', reactResponseController.delete);
